...
## I. Proposal
   ### Motivation: 서로 만난 팀원이 1학년이었습니다. 대학 생활에 대해 많은 경험을 하지 못했으며 대학교에 적응 단계이기에 주로 음주와 시험공부를 번갈아 하며 대학생활을 경험하였습니다. 이 상태에서 알코올 섭취와 성적에 관한 데이터셋을 발견하게 되었고, 가장 공감이 되는 주제라 생각하게 되어 진행하게 되었습니다.
